...
exports.pluginLoader = function(server, name, opts, doneHandler) {
...
exports.pluginErrorAsyncCallback = function(name, cb, next) {
...
exports.loadRouteTable = function(server, routeTable) {
  var routes = [];
